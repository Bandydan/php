...
* `arry_map` - применяет функцию, имя которой идет первым параметром в кавычках, ко всем элементам массива
...
4. [https://www.codeeval.com/open_challenges/18/](https://www.codeeval.com/open_challenges/18/
)  
5.  [https://www.codeeval.com/open_challenges/19/](https://www.codeeval.com/open_challenges/19/
)
