...
3. Написать отзывы о программе **envelops.php**: список того, что нравится, что не нравится, что, по вашему мнению, можно улучшить.
4. Подготовить список вопросов обо всем, что было за урок непонятного.
5. Приступить к настройке среды для разработки на PHP на своем компьютере.
6. Все блок-схемы оформить в электронном виде так, как написано в уроке, текст написать в google doc файле и выложить в свою папку на google disc.
